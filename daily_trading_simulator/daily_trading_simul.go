...
func (s S일일가격정보_저장소) g일자_도우미(일자_모음 []time.Time, 일자 time.Time, 일자_차이 int) (time.Time, error) {
	...
	case 일자_차이 < 0 && 당일_인덱스 < 일자_차이*-1,
		...
		return time.Time{}, lib.F에러_생성("데이터 없음. %v %v", 당일_인덱스, 일자_차이)
	default:
...
func (s S일일가격정보_저장소) G전일_종가(종목코드 string, 일자 time.Time) (int64, error) {
	...
	if 전일_가격정보 == nil {
		return -1, lib.F에러_생성("전일 가격정보를 찾을 수 없습니다. %v", 일자.Format(lib.P일자_형식))
	}
...
func (s S일일가격정보_저장소) G당일_시가(종목코드 string, 일자 time.Time) (int64, error) {
	...
	if 당일_가격정보 == nil {
		return -1, lib.F에러_생성("당일 가격정보를 찾을 수 없습니다. %v", 일자.Format(lib.P일자_형식))
	}
...
func (s S일일가격정보_저장소) G익일_시가(종목코드 string, 일자 time.Time) (int64, error) {
	...
	if 익일_가격정보 == nil {
		return -1, lib.F에러_생성("익일 가격정보를 찾을 수 없습니다. %v", 일자.Format(lib.P일자_형식))
	}

	return 익일_가격정보.G조정시가(), nil
}

func (s S일일가격정보_저장소) G상향돌파(종목코드 string, 일자 time.Time, 장_개시_종료 uint8, 기준단가 int64) bool {
	전일_가격정보 := s.G전일_가격정보(종목코드, 일자)
	당일_가격정보 := s.G당일_가격정보(종목코드, 일자)
...
func (s S일일가격정보_저장소) G하향돌파(종목코드 string, 일자 time.Time, 장_개시_종료 uint8, 기준단가 int64) bool {
	전일_가격정보 := s.G전일_가격정보(종목코드, 일자)
	당일_가격정보 := s.G당일_가격정보(종목코드, 일자)
...
func (s *S포트폴리오) S종목별_손절매(가격정보_저장소 *S일일가격정보_저장소, 종목코드 string,
	일자 time.Time, 장_개시_종료 uint8) bool {
...
func (s *S포트폴리오) S전종목_손절매(가격정보_저장소 *S일일가격정보_저장소, 일자 time.Time, 장_개시_종료 uint8) {
	일자 = lib.F2일자(일자)
